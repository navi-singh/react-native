...
class PeopleDetail extends Component {
    handleClick = (link) => {
        Linking.canOpenURL(link).then(supported => {
            if (supported) {
                ...
                console.log("Dont know how to open:" + link);
            }
        });
    };
    ...
    render() {
        return (
            <ScrollView showVerticaclSCrollIndicator={false}>
                <Image
                ...
                <Text style={[theme.cardTitleStyle, styles.title2]}>{this.props.person.comapany}</Text>
                ...
                <View style={styles.actionArea}>
                    ...
                    <TouchableOpacity
                        onPress={() => { this.handleClick(`email:${this.props.person.email}`) }}>
